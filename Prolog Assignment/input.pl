...
packet(5,  ['A', 459, aarp, 	'172.17.2.11', '123.45.45.12',	 2,		tcp, 	80,	    80]).
packet(6,  ['C', 700, mpls, 	'172.17.2.15', '10.10.1.3',		 9,	    tcp,	8080,   80]).
packet(7,  ['H', 700, netbui, '172.17.2.19', '23.45.45.23',	 3,     tcp, 	90,		80]).
packet(8,  ['E', 269, arp, 	'172.17.2.19', '45.23.12.45',	 1, 	udp, 	90,		69,	 3, 9]).
...
packet(14, ['C', 500, ipx, 	'172.17.2.55', '172.17.2.11',	 9, 	tcp, 	8080,	1000]).
packet(15, ['H', 500, ipx, 	'10.10.3.91',   '172.17.2.13',	 34, 	tcp, 	90,	    9000]).
packet(16, ['E', 500, ipx, 	'172.17.2.38', '172.56.23.11',	 7, 	tcp, 	1000,   90]).
packet(17, ['A', 500, ipx, 	'172.17.2.21', '123.45.45.12',	 2, 	tcp, 	80,	    78]).
packet(18, ['C', 500, ipx, 	'172.17.2.25', '10.10.1.3',		 9, 	tcp, 	8080,   45]).
packet(19, ['H', 500, ipx, 	'172.17.2.24', '23.45.45.23',	 3, 	tcp, 	90,	    90]).
